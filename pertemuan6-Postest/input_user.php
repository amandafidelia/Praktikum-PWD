...
$no_telp = $_POST['no_telp']; //variabel yang menyimpan nomor telepon yang didapat dari form_user
...
$sql = "INSERT INTO users(id_user,password, nama_lengkap, email, no_telp) VALUES ('$id_user', '$pass', 
